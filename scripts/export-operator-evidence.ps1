...
$bundle = [ordered]@{
    ...
    summary = [ordered]@{
        ...
        operator_next_action = $readiness.operator_next_step.action
        operator_next_priority = $readiness.operator_next_step.priority
        ...
        schwab_connection_status = $schwabStatus.connection_status
        schwab_access_token_active = $schwabStatus.access_token_active
        schwab_refresh_token_available = $schwabStatus.refresh_token_available
    ...
    evidence = [ordered]@{
        health = $health
        readiness = $readiness
        operator_next_step = $readiness.operator_next_step
