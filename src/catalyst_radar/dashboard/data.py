...
def priced_in_preflight_payload(
    ...
    *,
    ...
    return {
        ...
        "canonical_first_blocker": first_blocker.get("area"),
        "first_gap_count": int(_finite_float(first_blocker.get("source_gap_count"))),
        "canonical_next_action": operator_next_step.get("action"),
        "canonical_next_command": operator_next_step.get("command"),
