...
def market_bars_status_payload(
    ...
    *,
    ...
    return {
        ...
        "canonical_first_blocker": "market_bars" if missing_any else None,
        "first_gap_count": missing if missing_any else 0,
        "canonical_next_action": next_action,
        "canonical_next_command": recommended_action.get("command"),
...
def _expected_as_of_required_status_payload(
    *,
    ...
    return {
        ...
        "canonical_first_blocker": "market_bars",
        "first_gap_count": active_security_count,
        "canonical_next_action": action,
        "canonical_next_command": status_command,
        "expected_as_of": None,
...
def _setup_required_status_payload(
    ...
    *,
    ...
    return {
        ...
        "canonical_first_blocker": "universe",
        "first_gap_count": 0,
        "canonical_next_action": action,
