    ...
    def as_payload(self) -> dict[str, object]:
        ...
        saved_file_capture_approval_packet = (
            provider_saved_file_capture_approval_packet(
                ...
                missing_as_of_bar_ticker_more=max(0, missing - len(missing_sample)),
...
def provider_saved_file_capture_approval_packet(
    *,
    ...
    existing_as_of_bar_count: int | None,
    missing_as_of_bar_count: int,
    missing_as_of_bar_ticker_sample: list[str],
    missing_as_of_bar_ticker_more: int,
    missing_security_type_counts: Mapping[str, int],
    missing_universe_diagnostic: Mapping[str, object],
    provider_key_configured: bool,
    ...
    return {
        ...
        "missing_as_of_bar_ticker_sample": list(missing_as_of_bar_ticker_sample),
